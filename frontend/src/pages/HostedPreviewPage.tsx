...
import { ArrowLeft, MessageCircle, X, Send, Bot, Copy, Check, Phone, Mail, Globe, Clock } from 'lucide-react';
import './HostedPreviewPage.css';
...
const HostedPreviewPage: React.FC = () => {
    ...
    if (loading) {
        return (
            <div className="hosted-preview-page">
...
export default HostedPreviewPage;
